...
export const umActuallyQuestions: Question[] = [
  ...
  {
    type: QuestionType.UmActually,
    startString: `Hobbits have a famous love of food. When they can get it, a hobbit's daily meals consist of breakfast, second breakfast, elevenses, luncheon, afternoon tea, and supper.`,
    endString: `Dinner should also be included in that list.`,
  },
  {
    type: QuestionType.UmActually,
  ...
  },
  {
    ...
    endString: `Clarke and Kubrick worked on the novel and film at the same time, consulting with each other, so neither is based on the other.`,
  },
  {
    type: QuestionType.UmActually,
  ...
  },
  {
    ...
    endString: `When Arthur returns with the shrubbery, The Knights are no longer The Knights Who Say "Ni!", they have become The Knights Who Say "Ekki-Ekki-Ekki-Ekki-PTANG Zoom-Boing Z'nourrwringmm".`,
  },
  {
    type: QuestionType.UmActually,
